...
ugfx.input_attach(ugfx.BTN_BOOT, exitApp)
ugfx.input_attach(ugfx.JOY_B, lambda pushed: ugfx.flush() if pushed else 0)
ugfx.input_attach(ugfx.JOY_C, lambda pushed: ugfx.flush() if pushed else 0)

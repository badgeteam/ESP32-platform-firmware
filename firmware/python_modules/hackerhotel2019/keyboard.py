...
def draw():
	...
	display.drawRect(0, yOffset, display.width(), display.height()-yOffset, False, 0x000000)
	...
	for y in range(3):
		for x in range(10):
			...
			if x == cx and y == cy:
				selected = True
			if width > 0:
				display.drawRect(x*widthOffset+xOffset, y*20+yOffset, width, 20, True, 0xFFFFFF)
				display.drawRect(x*widthOffset+xOffset, y*20+yOffset, width, 20, selected, 0x000000)
				color = 0
				if selected:
					color = 0xFFFFFF
				offset = shift*3
				...
				display.drawText(x*widthOffset+cxo, y*20+yOffset+charOffsetY, charMap[y+offset][x], color, keyFont)
			
	if mode == 2:
		display.drawRect(8,yOffset+8,display.width()-16, display.height()-yOffset-16, True, 0xFFFFFF)
		display.drawRect(8,yOffset+8,display.width()-16, display.height()-yOffset-16, False, 0x000000)
		display.drawText(12,yOffset+12, "Press A to accept input", 0x000000, "Roboto_Regular12")
		display.drawText(12,yOffset+12+14, "Press B to cancel", 0x000000, "Roboto_Regular12")

# Troopers 2020 button input wrapper
...
def __init():
    pca9555.attach    ( __pcaMap[BTN_A],      __cb_btn_a      ) # The A button is connected to input 0 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_B],      __cb_btn_b      ) # The B button is connected to input 1 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_START],  __cb_btn_start  ) # The START button is connected to input 2 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_SELECT], __cb_btn_select ) # The SELECT button is connected to input 3 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_DOWN],   __cb_btn_down   ) # The DOWN button is connected to input 4 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_RIGHT],  __cb_btn_right  ) # The RIGHT button is connected to input 5 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_UP],     __cb_btn_up     ) # The UP button is connected to input 6 of the MPR121
    pca9555.attach    ( __pcaMap[BTN_LEFT],   __cb_btn_left   ) # The LEFT button is connected to input 7 of the MPR121

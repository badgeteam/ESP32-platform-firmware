...
void platform_init() {
  ...
  INIT_DRIVER(eink,
              "E-INK")  // 296x128 e-ink display as found on the SHA2017 and HackerHotel 2019 badges
  ...
  INIT_DRIVER(mpr121, "MPR121")  // I/O expander with touch inputs as found on the SHA2017 and
                                 // HackerHotel 2019 badges
  INIT_DRIVER(disobey_samd, "SAMD")  // I/O via the SAMD co-processor on the Disobey 2019 badge
  INIT_DRIVER(neopixel,
              "NEOPIXEL")  // Addressable LEDs as found on the SHA2017 and HackerHotel 2019 badges

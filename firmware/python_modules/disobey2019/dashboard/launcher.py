...
def drawMessageBox(text):
	...
	display.drawText((display.width()-width)//2, (display.height()-height)//2-2, text, 0x111111, "org18")

def drawApp(app, position, amount):
	display.drawFill(0x111111)
	display.drawRect(0,0,display.width(), 10, True, 0xFFFFFF)
	display.drawText(2, 0, "LAUNCHER", 0x111111, "org18")
	...
	display.drawText(display.width()-positionWidth-2, 0, positionText, 0x111111, "org18")

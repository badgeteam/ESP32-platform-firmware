...
class List():
	...
	def destroy(self):
		...
		self.selected = 0
		activeList = None
		_inputAttach(BTN_B, listUpCallback, self)
		_inputAttach(BTN_C, listDownCallback, self)
	...
	def enabled(self, val):
		...
		if self._enabled:
			activeList = self
			_inputAttach(BTN_B, self._onUp, self)
			_inputAttach(BTN_C, self._onDown, self)
		else:
			activeList = None
			_inputAttach(BTN_B, listUpCallback, self)
			_inputAttach(BTN_C, listDownCallback, self)

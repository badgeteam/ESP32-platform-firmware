...
i2c = machine.I2C(sda=machine.Pin(22), scl=machine.Pin(21), freq=10000)
...
def transaction(out,maxLength=256):
	data = [1]
	data.extend(out)
	res = call_function(PN532_COMMAND_INDATAEXCHANGE, maxLength, data)
	if res[0] != 0x00:

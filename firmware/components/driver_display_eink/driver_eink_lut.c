...
static uint8_t
driver_eink_lut_conv(uint8_t voltages, enum driver_eink_lut_flags flags)
{
...
// GDEH029A1
int
driver_eink_lut_generate_gdeh029a1(const struct driver_eink_lut_entry *list, enum driver_eink_lut_flags flags, uint8_t *lut)
{
...
// DEPG0290B01
int
driver_eink_lut_generate_depg0290b1(const struct driver_eink_lut_entry *list, enum driver_eink_lut_flags flags, uint8_t *lut)
{
	ESP_LOGD(TAG, "flags = %d.", flags);
...
int
driver_eink_lut_generate(const struct driver_eink_lut_entry *list, enum driver_eink_lut_flags flags, uint8_t *lut)
{

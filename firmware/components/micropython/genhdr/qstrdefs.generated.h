...
QDEF(MP_QSTR_COPROC_RESERVE_MEM, (const byte*)"\x22\x52\x12" "COPROC_RESERVE_MEM")
...
QDEF(MP_QSTR_GPIO_CLK, (const byte*)"\xef\xed\x08" "GPIO_CLK")
QDEF(MP_QSTR_GPIO_SDA, (const byte*)"\xfd\x32\x08" "GPIO_SDA")
...
QDEF(MP_QSTR_disablecomp, (const byte*)"\x00\x41\x0b" "disablecomp")
...
QDEF(MP_QSTR_enablecomp, (const byte*)"\x15\x09\x0a" "enablecomp")
...
QDEF(MP_QSTR_framerate, (const byte*)"\xba\x3f\x09" "framerate")
...
QDEF(MP_QSTR_hub75, (const byte*)"\x18\xd3\x05" "hub75")
...
QDEF(MP_QSTR_ramdump, (const byte*)"\xd7\xf9\x07" "ramdump")
QDEF(MP_QSTR_raminfo, (const byte*)"\x55\x34\x07" "raminfo")
...
QDEF(MP_QSTR_scrolltext, (const byte*)"\xb5\x15\x0a" "scrolltext")
...
QDEF(MP_QSTR_timezone, (const byte*)"\xee\xaa\x08" "timezone")
